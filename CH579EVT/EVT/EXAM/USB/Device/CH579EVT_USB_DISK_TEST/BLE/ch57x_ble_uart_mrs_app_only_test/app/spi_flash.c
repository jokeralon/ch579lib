...
//     // bsp_spi0_write(CMD_PAGE_PROG, StarAddr, Len, RcvBuffer);
...
//     hal_device_write(fd, &spi_data_buff, 0);
...
// {
//     // bsp_spi0_read(CMD_READ_DATA, StarAddr, Len, RcvBuffer);
...
//     hal_device_read(fd, &spi_data_buff, 0);
// }
// /*******************************************************************************
