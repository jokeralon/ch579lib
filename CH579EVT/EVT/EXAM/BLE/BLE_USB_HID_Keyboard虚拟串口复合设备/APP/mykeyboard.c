...
//				/* 特殊键处理 */
//				if( Keyboard_temp[ row_scanf_num ][ col_scanf_num ] == MODE_SW )
//				{
//					if(keyboard_mode_flag == USB_MODE)
//					{
//						keyboard_mode_flag = BLE_MODE;
...
//				}
				if(fn_flag == 1) // FN
				{
					...
					else if( strcmp(Keyboard_Map_Name[ row_scanf_num ][ col_scanf_num ],"10") == 0)		//FN F10
					{
						buf[i] = myKeyBoard_FN_ATValue[9];
						i++;
					}
					else if( strcmp(Keyboard_Map_Name[ row_scanf_num ][ col_scanf_num ],"11") == 0)		//FN F11
					{
						buf[i] = myKeyBoard_FN_ATValue[10];
						i++;
					}
					else if( strcmp(Keyboard_Map_Name[ row_scanf_num ][ col_scanf_num ],"12") == 0)		//FN F12
					{
